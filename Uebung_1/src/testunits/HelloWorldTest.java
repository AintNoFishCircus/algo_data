 ...
 * 
 * Kleines Testprogramm zur Überprüfung des Inhalts des Ausgabestroms aus HelloWorld.java
 */
public class HelloWorldTest {
	...
	/**
	 * Ausgabestrom in PrintStream umleiten um ihn mit dem erwarteten Wert vergleichen zu können
	 */
	@Before
